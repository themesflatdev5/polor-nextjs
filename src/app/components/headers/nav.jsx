...
import { demos, features} from "../../../../data/menu.js";
  ...
  const isParentActive = (menus) =>
    ...
    return (
        <>
          <li
            className={`has-child ${
                demos.some((elm) => elm.href == pathname) ? "current-menu" : ""
            }`}
          >
            <a href="#">Demos</a>
            <ul className="submenu">
              {demos.map((item, index) => (
                <li
                  key={index}
                  className={pathname == item.href ? "current-menu-item" : ""}
                >
              ...
              {features.map((menu, index) => (
                <li
                  ...
                  className={`${menu.className || ""}  ${
                    isParentActive(menu.submenu || []) ? "current-menu-item" : ""
                  }   ${
                    menu.href?.split("/")[1] == pathname.split("/")[1]
                      ? "current-menu-item"
                      : ""
