...
export default function Newsletter() {
    return (
        <div className="section-newsletter style-1 ">
            <div className="tf-container">
                <div className="row">
                    <div className="col-lg-5">
                        <div className="wrap-form">
                            <div className="heading-section  mb_20">
                                <div className="text-body-2 text_mono-gray-5 mb_12">
                                    Newsletter
                                </div>
                                <h4 className="fw-6">
                    ...
                    <div className="col-lg-7">
                        <div className="right d-grid gap_11">
                            <div className="tf-grid-layout tf-col-2 md-col-4">
                                <div className="hover-image-2">
                                    <a className="image-rotate" href="#">
                                        <Image
                                            alt="newsletter"
                                            src="/assets/images/section/newsletter-1.jpg"
                                            width={255.75}
                                            height={255.75}
                                        />
                                    </a>
                                ...
                                <div className="hover-image-2">
                                    <a className="image-rotate" href="#">
                                        <Image
                                            alt="newsletter"
                                            src="/assets/images/section/newsletter-3.jpg"
                                            width={255.75}
                                            height={255.75}
                                        />
                                    </a>
                                ...
                                <div className="box-item">
                                    ...
                                    <a className="tf-btn style-2" href="#">
                                        <span className="text-body-3 fw-6">
                                            @polor
                                        </span>
                                    </a>
                                </div>
